...
"""
    runPDQN(save_dir, landing_factor=1, leg_first_bonus=0)

Trains the modified LunarLander agent using PDQN
...
"""
function runPDQN(save_dir::T, landing_factor=1, leg_first_bonus=0) where {T<:AbstractString}
